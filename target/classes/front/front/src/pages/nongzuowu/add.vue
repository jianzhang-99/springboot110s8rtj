...
<div :style='{"width":"100%","padding":"20px 10%","margin":"30px auto","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","float":"left","display":"inline-block"}' label="预计收获" prop="yujishouhuo">
              <el-date-picker
				  :disabled=" false  ||ro.yujishouhuo"
                  format="yyyy 年 MM 月 dd 日"
                  value-format="yyyy-MM-dd"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","float":"left","display":"inline-block"}' label="施肥计划" prop="shifeijihua">
            <editor 
