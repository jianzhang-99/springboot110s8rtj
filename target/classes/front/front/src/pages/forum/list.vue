...
<div class="forum-preview" :style='{"width":"100%","padding":"20px 10%","margin":"30px auto","position":"relative"}'>
    <div :style='{"border":"1px solid #333","width":"100%"}'>
		<div :style='{"padding":"0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#0F672D","textAlign":"center","width":"100%","lineHeight":"54px","fontSize":"20px","textOverflow":"ellipsis","fontWeight":"700","height":"54px"}'>论坛</div>
	</div>
